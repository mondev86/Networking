...
// Computed para la etiqueta de rol
...
// ✅ NUEVO: Permiso para ver Equipment (todos los usuarios autenticados)
        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <!-- ✅ NUEVO: Enlace a Equipment (todos ven pero con permisos diferentes) -->
                            <NavLink
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <!-- ✅ NUEVO: Enlace a Equipment en mobile -->
                    <ResponsiveNavLink
                      v-if="canViewEquipment"
                      :href="route('equipment.index')"
                      :active="route().current('equipment.*')"
